...
cookies = {
    'ttwid': '1%7Cr8wit_9ekM_si8Zt_HO1kvUJp7kwM05nt12vjBWJ1oU%7C1715345436%7C5438bcbfa79b366c70cdda19142de5c770d5c3d5f8e672032847c0166e19e088',
    'tt_webid': '7367352466684741139',
    'tt_web_version': 'new',
    'is_dev': 'false',
    'is_boe': 'false',
    ...
    'msToken': 'WvmRt7YTa-q5LFEDa-oOUjq-DNiHvtJIARIZag8TOJGYbM7dY_uu4CsT0oM0592YDg-nBFzaHt01wmNvYzaJSXl9C4Cz5IEqBMJkYebC',
    'Hm_lpvt_3e79ab9e4da287b5752d8048743b95e6': '1715346364',
}
...
response = requests.get('https://www.dongchedi.com/motor/car_page/v1/all_brand/', params=params, cookies=cookies, headers=headers)
print(response.json())